...
# Imported after the warnings filter so it applies to urllib3 at import time.
from services.activity_processor import ActivityProcessor  # noqa: E402
from services.fit_file_service import FitFileService  # noqa: E402
from services.garmin_service import GarminService  # noqa: E402
from services.mywhoosh_service import MyWhooshService  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        mywhoosh_service = MyWhooshService(config["mywhoosh_email"], config["mywhoosh_password"])
        ...
        processor = ActivityProcessor(mywhoosh_service, fit_file_service, garmin_service)
        ...
        if args.batch:
            ...
            stats = processor.process_multiple_activities(
                limit=args.batch, check_duplicates=check_duplicates
            )
